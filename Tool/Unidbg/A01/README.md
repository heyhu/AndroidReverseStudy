...
- [基础配置](#基础配置)
  - [1.1 初始化](#1.1 初始化)
  - [1.2 执行目标函数--参数构造](#1.2 执行目标函数--参数构造)
    - [1.2.1 字节数组以及布尔值](#1.2.1 字节数组以及布尔值)
    - [1.2.2 context以及字符串类型](#1.2.2 context以及字符串类型)
    - [1.2.3 treemap](#1.2.3 treemap)
    - [1.2.4 对象数组](#1.2.4 对象数组)
